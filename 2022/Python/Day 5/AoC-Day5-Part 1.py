def D5P1(input):
  ...
  for instruct in instruction_section:
    ...
    for crates in range(int(instruction[0])):
      crate_list[int(instruction[4])-1].append(crate_list[int(instruction[2])-1].pop())
...
assert(D5P1('D5 Test.txt') == 'CMZ'), "Function does not match example provided"

if __name__ == '__main__':
  print(D5P1('D5 Input.txt'))
